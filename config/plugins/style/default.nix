...

{
  ...
  config = lib.mkIf config.colorschemes.enable {
    colorschemes = {
      ...
      gruvbox = lib.mkIf (config.colorschemes.selected == "gruvbox") {
        enable = true;
      };

      nord = lib.mkIf (config.colorschemes.selected == "nord") {
        enable = true;
      };
      ...
      dracula = lib.mkIf (config.colorschemes.selected == "dracula") {
        enable = true;
      };

      onedark = lib.mkIf (config.colorschemes.selected == "onedark") {
        enable = true;
      };
      ...
      ayu = lib.mkIf (config.colorschemes.selected == "ayu") {
        enable = true;
      };

      base16 = lib.mkIf (config.colorschemes.selected == "base16") {
        enable = true;
      };
      ...
      melange = lib.mkIf (config.colorschemes.selected == "melange") {
        enable = true;
      };

      modus = lib.mkIf (config.colorschemes.selected == "modus") {
        enable = true;
      };
      ...
      one = lib.mkIf (config.colorschemes.selected == "one") {
        enable = true;
      };
      ...
      palette = lib.mkIf (config.colorschemes.selected == "palette") {
        enable = true;
      };
      ...
      vscode = lib.mkIf (config.colorschemes.selected == "vscode") {
        enable = true;
      };
    };
  };
