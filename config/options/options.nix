  ...
  extraFiles = {
    "syntax/cisco.vim" = {
      text = ''
        ...
        syn keyword ciscoKeyword    privilege secret interval
        ...
        syn keyword ciscoConfigure  activate set default bfd ip redundancy prefe ron tag
        ...
        hi link ciscoInterface      Boolean
